...
- Sample Makefile workflows and a public example fixture.
- GitHub Actions binary workflow for Linux x86_64, macOS x86_64, macOS arm64, and Windows x86_64 release artifacts.
- User-global installation instructions for Cargo, Linux, macOS, and Windows.
...
- `make sample-verify-llm` runs the advisory OpenAI judge over the sample candidate when `OPENAI_API_KEY` is set.
...
- Internal design docs and repository-local instructions from the public package surface.
